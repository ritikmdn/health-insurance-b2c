...
export default function ComponentGrid() {
  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
      ...
      <Tooltip content="Simple.life is your personal AI life insurance advisor that helps you find term insurance plans that are tailored to your requirements and needs.">
